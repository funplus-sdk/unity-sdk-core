...
@interface OS_dispatch_queue (SWIFT_EXTENSION(Alamofire))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OS_dispatch_queue * _Nonnull userInteractive;)
+ (OS_dispatch_queue * _Nonnull)userInteractive;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OS_dispatch_queue * _Nonnull userInitiated;)
+ (OS_dispatch_queue * _Nonnull)userInitiated;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OS_dispatch_queue * _Nonnull utility;)
+ (OS_dispatch_queue * _Nonnull)utility;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OS_dispatch_queue * _Nonnull background;)
+ (OS_dispatch_queue * _Nonnull)background;
- (void)after:(NSTimeInterval)delay execute:(void (^ _Nonnull)(void))closure;
@end
