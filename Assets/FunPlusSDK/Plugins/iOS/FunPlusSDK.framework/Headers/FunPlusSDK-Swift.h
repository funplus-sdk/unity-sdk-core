...
+ (void)installWithAppId:(NSString * _Nonnull)appId appKey:(NSString * _Nonnull)appKey rumTag:(NSString * _Nonnull)rumTag rumKey:(NSString * _Nonnull)rumKey environment:(NSString * _Nonnull)environment loggerUploadInterval:(int64_t)loggerUploadInterval rumUploadInterval:(int64_t)rumUploadInterval rumSampleRate:(double)rumSampleRate rumEventWhitelistString:(NSString * _Nonnull)rumEventWhitelistString rumUserWhitelistString:(NSString * _Nonnull)rumUserWhitelistString rumUserBlacklistString:(NSString * _Nonnull)rumUserBlacklistString dataUploadInterval:(int64_t)dataUploadInterval dataAutoTraceSessionEvents:(BOOL)dataAutoTraceSessionEvents;
